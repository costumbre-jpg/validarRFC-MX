  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-gray-600">Gestiona tu información personal y preferencias de cuenta</p>
      </div>

      {/* Perfil de Usuario */}
      <div className="bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-md border border-gray-200 p-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
          <div className="relative">
            {userData?.avatar_url ? (
              <img
                ...
                alt={displayName}
                className="h-28 w-28 rounded-full object-cover border-4 border-white shadow-xl ring-2 ring-gray-100"
              />
            ) : (
              <div 
                className="h-28 w-28 rounded-full flex items-center justify-center text-4xl font-bold text-white shadow-xl ring-2 ring-gray-100"
            ...
            <button
              ...
              className="absolute bottom-0 right-0 h-10 w-10 rounded-full bg-white border-2 flex items-center justify-center shadow-lg hover:shadow-xl transition-all hover:scale-105 cursor-pointer"
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="space-y-2 mb-4">
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm text-gray-700 font-medium">{safeUser?.email}</p>
              </div>
              {userData?.phone && (
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-sm text-gray-700 font-medium">{userData.phone}</p>
                </div>
              )}
            </div>
            <div className="flex items-center gap-2 flex-wrap">
              <span className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold ${planColor} border`}>
                Plan {planName}
              </span>
              ...
              {userData?.subscription_status === "free" && (
                <a
                  ...
                  className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-semibold transition-all hover:scale-105 border"
                  style={{ 
          ...
          <div className="w-full sm:w-auto">
            <button
              onClick={() => setShowEditModal(true)}
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg text-sm font-semibold text-white transition-all shadow-md hover:shadow-lg hover:scale-105"
              style={{ backgroundColor: brandPrimaryColor }}
            >
        ...
        <div className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
              ...
              <div className="flex items-center gap-2">
                <p className="text-sm text-gray-900 font-medium">{safeUser?.email}</p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
              <div className="flex items-center gap-2 mb-2">
                ...
                <label className="text-sm font-semibold text-gray-700">Plan Actual</label>
              </div>
              <div className="flex items-center gap-3 flex-wrap">
                <span className={`inline-flex items-center px-3 py-1.5 rounded-full text-sm font-bold ${planColor} border`}>
                  {planName}
                </span>
                {userData?.subscription_status === "free" && (
                  <a
                    href={`/dashboard/billing${searchParams.get("plan") && ["pro", "business"].includes(searchParams.get("plan")!) ? `?plan=${searchParams.get("plan")}` : ""}`}
                    className="inline-flex items-center gap-1 text-sm font-semibold transition-all hover:scale-105"
            ...
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <p className="text-sm text-gray-900 font-semibold">México</p>
              </div>
            </div>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
              ...
              <p className="text-sm text-gray-500 font-mono bg-white px-2 py-1 rounded border border-gray-200 inline-block">{safeUser?.id?.substring(0, 8)}...</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
        ...
        {(() => {
          ...
          return (
            <div className={`grid gap-6 ${isPro ? 'md:grid-cols-4' : 'md:grid-cols-3'}`}>
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-5 border-2 border-l-4 shadow-md hover:shadow-lg transition-shadow" style={{ borderLeftColor: brandPrimaryColor }}>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-sm font-semibold text-gray-700">Validaciones este mes</p>
                </div>
                <p className="text-4xl font-bold mb-1" style={{ color: brandPrimaryColor }}>{queriesThisMonth}</p>
              ...
              {isPro ? (
                <>
                  <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-5 border-2 border-l-4 shadow-md hover:shadow-lg transition-shadow" style={{ borderLeftColor: brandPrimaryColor }}>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <p className="text-sm font-semibold text-gray-700">Total validaciones</p>
                    </div>
                    <p className="text-4xl font-bold mb-1" style={{ color: brandPrimaryColor }}>
                  ...
                  <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-5 border-2 border-l-4 shadow-md hover:shadow-lg transition-shadow" style={{ borderLeftColor: brandPrimaryColor }}>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <p className="text-sm font-semibold text-gray-700">Llamadas API</p>
                    </div>
                    <p className="text-4xl font-bold mb-1" style={{ color: brandPrimaryColor }}>
                ...
                <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-5 border-2 border-l-4 border-gray-200 shadow-md">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <p className="text-sm font-semibold text-gray-700">Total de validaciones</p>
                  </div>
                  <p className="text-4xl font-bold text-gray-300 mb-1">-</p>
                  <p className="text-xs text-gray-500">Disponible en planes Pro+</p>
                </div>
              )}
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-5 border-2 border-l-4 border-gray-200 shadow-sm">
                <div className="flex items-center gap-2 mb-3">
                  <div className="p-2 rounded-lg bg-gray-100">
                    <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-100 hover:bg-gray-100 transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-gray-900">Autenticación de dos factores</p>
                <p className="text-xs text-gray-500 mt-0.5">Aumenta la seguridad de tu cuenta</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-100 hover:bg-gray-100 transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">Actualiza tu contraseña regularmente</p>
              </div>
            </div>
            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-amber-100 text-amber-800 border border-amber-200">
              Próximamente
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-100 hover:bg-gray-100 transition-colors">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-gray-900">Sesiones activas</p>
                <p className="text-xs text-gray-500 mt-0.5">Gestiona tus dispositivos conectados</p>
              </div>
            </div>
            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-amber-100 text-amber-800 border border-amber-200">
              Próximamente
