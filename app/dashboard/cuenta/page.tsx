        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 max-md:gap-3">
          <div className="relative">
            ...
            <button
              ...
              className="absolute bottom-0 right-0 h-8 w-8 max-md:h-7 max-md:w-7 rounded-full bg-white border-2 flex items-center justify-center shadow-md hover:shadow-lg transition-all hover:scale-105 cursor-pointer z-10 disabled:opacity-50 disabled:cursor-not-allowed"
              style={{ borderColor: brandPrimaryColor }}
              title="Cambiar foto de perfil"
            >
              {uploadingAvatar ? (
                <svg className="animate-spin h-4 w-4 max-md:h-3.5 max-md:w-3.5" style={{ color: brandPrimaryColor }} fill="none" viewBox="0 0 24 24">
