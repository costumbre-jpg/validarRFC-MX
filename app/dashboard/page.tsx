    ...
    <Suspense fallback={null}>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <Link
                ...
                className="inline-flex items-center justify-center px-3 py-2 rounded-lg text-xs font-semibold text-white bg-[#2F7E7A] hover:bg-[#1F5D59]"
              >
                Activar Pro
              </Link>
              <button
      ...
      {userData?.subscription_status === "free" && (
        <div className="grid md:grid-cols-2 gap-6 max-md:gap-4">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 max-md:p-4">
            ...
            <div className="space-y-4 max-md:space-y-3">
              <div className="flex items-start gap-3 max-md:gap-2">
                <div className="flex-shrink-0 w-6 h-6 max-md:w-5 max-md:h-5 bg-[#2F7E7A]/10 rounded-full flex items-center justify-center mt-0.5">
                  <span className="text-[#2F7E7A] text-xs max-md:text-[10px] font-bold">1</span>
                </div>
                <div>
              ...
              <div className="flex items-start gap-3 max-md:gap-2">
                <div className="flex-shrink-0 w-6 h-6 max-md:w-5 max-md:h-5 bg-[#2F7E7A]/10 rounded-full flex items-center justify-center mt-0.5">
                  <span className="text-[#2F7E7A] text-xs max-md:text-[10px] font-bold">2</span>
                </div>
                <div>
                  <p className="text-sm max-md:text-xs font-medium text-gray-900 mb-1 max-md:mb-0.5">
              ...
              <div className="flex items-start gap-3 max-md:gap-2">
                <div className="flex-shrink-0 w-6 h-6 max-md:w-5 max-md:h-5 bg-[#2F7E7A]/10 rounded-full flex items-center justify-center mt-0.5">
                  <span className="text-[#2F7E7A] text-xs max-md:text-[10px] font-bold">3</span>
                </div>
                <div>
                  <p className="text-sm max-md:text-xs font-medium text-gray-900 mb-1 max-md:mb-0.5">
          ...
          <div className="bg-gradient-to-br from-[#2F7E7A]/5 to-[#2F7E7A]/10 rounded-lg border border-[#2F7E7A]/20 p-6 max-md:p-4">
            ...
            <ul className="space-y-3 max-md:space-y-2 text-sm max-md:text-xs text-gray-700 mb-6 max-md:mb-4">
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 max-md:w-4 max-md:h-4 text-[#2F7E7A] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="pt-4 max-md:pt-3 border-t border-[#2F7E7A]/20">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center w-full px-4 max-md:px-3 py-2 max-md:py-1.5 bg-[#2F7E7A] text-white rounded-lg hover:bg-[#1F5D59] transition-colors font-medium text-sm max-md:text-xs"
              >
      ...
      {userData?.subscription_status === "pro" || userData?.subscription_status === "business" ? (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 max-md:p-4">
          <div className="flex items-center justify-between max-md:flex-col max-md:items-start max-md:gap-3">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 max-md:gap-1.5 px-5 max-md:px-4 py-2.5 max-md:py-2 bg-[#2F7E7A] text-white rounded-lg hover:bg-[#1F5D59] transition-colors font-semibold text-sm max-md:text-xs shadow-sm hover:shadow-md w-full max-md:w-full justify-center max-md:justify-center"
            >
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 max-md:p-3">
          <div className="text-center">
            ...
            <Link
              href={`/dashboard/billing${searchParams.get("plan") && ["pro", "business"].includes(searchParams.get("plan")!) ? `?plan=${searchParams.get("plan")}` : ""}`}
              className="inline-flex items-center gap-1.5 px-4 max-md:px-3 py-2 max-md:py-1.5 text-sm max-md:text-xs bg-[#2F7E7A] text-white rounded-lg hover:bg-[#1F5D59] transition-colors font-semibold shadow-sm hover:shadow-md"
            >
              Mejorar Plan
