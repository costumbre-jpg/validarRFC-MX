  ...
  return (
    <div className="space-y-6 max-md:space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="inline-flex items-center px-3 max-md:px-2.5 py-1.5 max-md:py-1 rounded-full bg-brand-primary-10 text-brand-primary text-sm max-md:text-xs font-medium mb-3 max-md:mb-2">
          ...
          <div key={categoryIndex} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="bg-gray-50 px-5 max-md:px-4 py-3 max-md:py-2.5 border-b border-gray-200">
              <div className="flex items-center gap-3 max-md:gap-2">
                <div className="p-1.5 max-md:p-1 rounded-md bg-brand-primary-10">
      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
        <div className="p-6 max-md:p-4">
          <div className="flex items-start gap-4 max-md:gap-3">
            <div className="p-2 max-md:p-1.5 rounded-lg bg-brand-primary-10">
