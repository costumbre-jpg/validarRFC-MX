...
export default function APIKeysPage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      if (!user) {
        ...
        // En modo diseño, si no se pasa plan, usar Pro por defecto para ver la funcionalidad
        const designPlan = planParam && ["pro", "business"].includes(planParam) ? planParam : "pro";
  ...
  const handleCreateKey = async () => {
    ...
    try {
      ...
      alert("Error al crear API Key. Por favor intenta de nuevo.");
    } finally {
      setCreating(false);
    }
  };
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-200 p-8">
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">API Keys Disponibles</h3>
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              Las API Keys están disponibles solo para planes Pro y Business. Crea claves para integrar nuestra API en tus aplicaciones.
            </p>
            <a
    ...
    <div className="space-y-8">
      <div>
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-2xl font-semibold text-gray-600">API Keys</h1>
          <Link
            href="/developers"
            className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-xl transition-all shadow-sm hover:shadow-md"
            style={{
              color: "var(--brand-primary, #2F7E7A)",
              border: "1px solid var(--brand-primary, #2F7E7A)",
            }}
          >
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 mb-6">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ backgroundColor: `${brandPrimary}15` }}>
            <svg className="w-5 h-5" style={{ color: brandPrimary }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
            </svg>
          </div>
          <div>
            <h2 className="text-base font-semibold text-gray-700">Crear Nueva API Key</h2>
            <p className="text-sm text-gray-500 mt-0.5">Asigna un nombre descriptivo para identificar esta clave</p>
          </div>
        </div>
        <div className="flex gap-3">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl transition-all focus:outline-none focus:ring-0 focus:border-gray-200"
        ...
        <div className="bg-gradient-to-r from-amber-50 to-yellow-50 border-2 border-amber-300 rounded-xl p-6 shadow-md">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
              ...
              <div className="bg-white rounded-xl p-4 border-2 border-amber-200 mb-4 shadow-sm">
                <div className="flex items-center justify-between gap-2">
                  <code className="text-sm font-mono text-gray-900 break-all flex-1">{newApiKey}</code>
                  <button
              ...
              <div className="flex gap-3">
                <button
                  onClick={() => handleCopyKey(newApiKey)}
                  className="inline-flex items-center gap-2 px-4 py-2 bg-amber-600 text-white rounded-xl hover:bg-amber-700 transition-all font-medium text-sm shadow-sm hover:shadow-md"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                  </svg>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-white text-gray-700 rounded-xl hover:bg-gray-50 transition-all font-medium text-sm border border-gray-300 shadow-sm hover:shadow-md"
                >
                  Ya la guardé
                </button>
              </div>
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 mb-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-base font-semibold text-gray-700">Tus API Keys</h2>
        ...
        {apiKeys.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-base font-medium text-gray-900 mb-2">No hay API Keys aún</h3>
                    ...
                    <tr key={key.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-gray-500">
                              Creada {new Date(key.created_at).toLocaleDateString("es-MX", { month: "short", day: "numeric" })}
                            </div>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          <code className="text-sm font-mono text-gray-700 bg-gray-100 px-3 py-1.5 rounded-lg border border-gray-200">{key.key_prefix}</code>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-red-600 hover:text-red-800 hover:bg-red-50 rounded-lg transition-all"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6 shadow-md">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-base font-semibold text-blue-900 mb-3">Información sobre API Keys</h3>
