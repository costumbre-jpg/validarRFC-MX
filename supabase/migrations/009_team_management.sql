...
-- Nota: Esta función se puede llamar desde la aplicación, pero también podemos usar crypto.randomUUID()
-- Por ahora, la aplicación generará el token directamente
